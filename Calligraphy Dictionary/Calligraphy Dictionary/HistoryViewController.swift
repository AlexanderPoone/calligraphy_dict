...
class HistoryViewController: UIViewController, UITableViewDataSource, GADBannerViewDelegate {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "CellHistory", for: indexPath) as! BlockListTableViewCell
...
//            nsps.lineBreakMode = .byTruncatingTail
    ...
    @objc private func removeRow(_ sender:UIButton) {
        DBManager.shared.deleteRecord(mSaved[sender.tag]["image"]!)
...
activity.popoverPresentationController?.sourceView = sender
    ...
    override func viewDidLoad() {
        ...
        mAdView.adUnitID = "ca-app-pub-9627209153774793/7813034892" //ca-app-pub-9627209153774793/2302339919"
        ...
        mTitle.text = NSLocalizedString("search_history", comment: "")
        ...
        mClearAllBtn.setIcon(prefixText: "", prefixTextColor: .white, icon: .fontAwesomeSolid(.trashAlt), iconColor: .white, postfixText: NSLocalizedString("clear_all", comment: ""), postfixTextColor: .white, backgroundColor: UIColor(named: "danger")!, forState: .normal, textSize: nil, iconSize: nil)
        mSaved = DBManager.shared.getHistory("zh_Hant")
